...
/**
 * REST controller for managing {@link com.almahealth.app.domain.Medication}.
 */
@RestController
@RequestMapping("/api")
public class MedicationResource {
    ...
    public ResponseEntity<MedicationDTO> createMedication(@Valid @RequestBody MedicationDTO medicationDTO, BindingResult bindingResult)
        ...
        if (bindingResult.hasErrors()) {
            throw new BadRequestAlertException("Validation error in medication dto", ENTITY_NAME, "validationerror");
        }
