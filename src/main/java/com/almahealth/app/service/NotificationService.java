...
public class NotificationService {
    ...
    /**
     *  Get all the notifications where Medication is {@code null}.
     *  @return the list of entities.
     */
    /*@Transactional(readOnly = true)
    public List<NotificationDTO> findAllWhereMedicationIsNull() {
        log.debug("Request to get all notifications where Medication is null");
        return StreamSupport
            .stream(notificationRepository.findAll().spliterator(), false)
            .filter(notification -> notification.getMedication() == null)
            .map(notificationMapper::toDto)
