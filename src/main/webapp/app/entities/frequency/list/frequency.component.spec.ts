...
describe('Frequency Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'frequency', component: FrequencyComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.frequencies?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to frequencyService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getFrequencyIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getFrequencyIdentifier).toHaveBeenCalledWith(entity);
