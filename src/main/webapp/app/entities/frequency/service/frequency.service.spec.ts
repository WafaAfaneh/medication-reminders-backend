...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../frequency.test-samples';

import { FrequencyService } from './frequency.service';

const requireRestSample: IFrequency = {
...
describe('Frequency Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Frequency', () => {
      ...
      const frequency = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(frequency).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a Frequency', () => {
      const frequency = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(frequency).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addFrequencyToCollectionIfMissing', () => {
      it('should add a Frequency to an empty array', () => {
        const frequency: IFrequency = sampleWithRequiredData;
      ...
      it("should add a Frequency to an array that doesn't contain it", () => {
        const frequency: IFrequency = sampleWithRequiredData;
        const frequencyCollection: IFrequency[] = [sampleWithPartialData];
        expectedResult = service.addFrequencyToCollectionIfMissing(frequencyCollection, frequency);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(frequency);
      });
      ...
      it('should add only unique Frequency to an array', () => {
        const frequencyArray: IFrequency[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const frequencyCollection: IFrequency[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const frequency: IFrequency = sampleWithRequiredData;
        const frequency2: IFrequency = sampleWithPartialData;
    ...
    describe('compareFrequency', () => {
      it('Should return true if both entities are null', () => {
        ...
        const compareResult = service.compareFrequency(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareFrequency(entity1, entity2);
        const compareResult2 = service.compareFrequency(entity2, entity1);
