...
type NotificationFormGroupContent = {
  ...
  displayName: FormControl<INotification['displayName']>;
  notes: FormControl<INotification['notes']>;
  startDate: FormControl<INotification['startDate']>;
  frequency: FormControl<INotification['frequency']>;
};
...
export class NotificationFormService {
  createNotificationFormGroup(notification: NotificationFormGroupInput = { id: null }): NotificationFormGroup {
    ...
    return new FormGroup<NotificationFormGroupContent>({
      ...
      displayName: new FormControl(notificationRawValue.displayName),
      notes: new FormControl(notificationRawValue.notes),
      startDate: new FormControl(notificationRawValue.startDate),
      frequency: new FormControl(notificationRawValue.frequency),
    });
  }
