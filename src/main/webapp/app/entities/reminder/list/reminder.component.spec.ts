...
describe('Reminder Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'reminder', component: ReminderComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to reminderService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getReminderIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getReminderIdentifier).toHaveBeenCalledWith(entity);
